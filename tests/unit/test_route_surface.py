...
EXPECTED_ROUTES = [
    ...
    "DELETE /api/folders/{folder_id}/sharing/email",
    "DELETE /api/folders/{folder_id}/sharing/group/{group_id}",
    ...
    "GET /api/folders/{folder_id}/sharing",
    ...
    "POST /api/folders/{folder_id}/sharing/email",
    "POST /api/folders/{folder_id}/sharing/group",
